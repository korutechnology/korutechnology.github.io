...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-gray-200">
        ...
        <div ref={ref} className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          ...
          >
            <div className="space-y-2">
              ...
              >
                At Koru Strategy Advisors, we bridge the gap between talent and
                opportunity. With years of experience in tech and retail, we
                provide unparalleled consulting and staffing solutions.
              </motion.p>
            </div>
          </motion.div>
        </div>
